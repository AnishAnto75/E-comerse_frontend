...
import AdminCarouselBannerComponent from './AdminCarouselBannerComponent'
import AdminCardBannerComponent from './AdminCardBannerComponent'
import AdminGroupBannerComponent from './AdminGroupBannerComponent'
import AdminCategoryBannerComponent from './AdminCategoryBannerComponent'
import { useDispatch } from 'react-redux'
import { adminDeleteBanner } from '../../../slices/adminSlice/adminBannerSlice'
  ...
  return (
    <div className='relative'>
        <div className='absolute top-0 right-0 flex gap-2'>
            {/* Edit */}
            <Button variant="text" size='sm' className='text-blue-500 px-5 py-1 '>
            ...
            {/* Delete */}
            <Button onClick={()=>setDeleteModal(!deleteModal)} color='red' className='px-5 py-1' variant="gradient">
