...
// Delivered
    ...
    const getStatusColor = () => {
        ...
        if (!confirmed.status ) return 'bg-red-500'
        return 'bg-green-500'
    }
    ...
    return (
        ...
        <div className='px-5 text-sm tracking-wide pb-2 text-sky-400 flex justify-end'>
            <button hidden={isAllUpdates} onClick={()=>setAllUpdates(true)} className='relative pr-5 font-poppins hover:text-sky-500'>
        ...
        <div className='border p-2 mx-5 relative'>
            ...
            <div className='hero text-lg pt-5'>All Updates</div>
...
//                 {/* placed */}
//                 <div className={` relative col-span-1 border-2 p-2 rounded-md -space-y-1 mt-5 ${placed.status && 'border-green-500'}`}>
//                     {placed.status && (<MdDoneAll className='bg-white absolute h-10 w-10 -top-5 text-green-500 p-1'/>) }
...
//                 </div>
//                 {/* Confirmed */}
//                 <div className={`col-span-1 border-2 p-2 rounded-md -space-y-1 relative ${confirmed.status && 'border-green-500'}`}>
//                     {confirmed.status && (<MdDoneAll className='bg-white absolute h-10 w-10 -top-5 text-green-500 p-1'/>) }
...
//                 </div>
//                 {/* out */}
//                 <div className={`col-span-1 border-2 p-2 rounded-md -space-y-1 relative ${out.status && 'border-green-500'}`}>
//                     {out.status && (<MdDoneAll className='bg-white absolute h-10 w-10 -top-5 text-green-500 p-1'/>) }
...
//                 </div>
//                 {/* Delivered */}
//                 <div className={`col-span-1 border-2 p-2 rounded-md -space-y-1 relative ${delivered.status && 'border-green-500'}`}>
//                     {delivered.status && (<MdDoneAll className='bg-white absolute h-10 w-10 -top-5 text-green-500 p-1'/>) }
...
//                 {/* Return Requested */}
//                 <div className={`col-span-1 border-2 p-2 rounded-md -space-y-1 relative ${ returnRequested.rejected ? 'border-red-500' : returnRequested.status ? 'border-green-500' : ''}`}>
//                     {returnRequested.rejected && (<RxCross2 className={`bg-white absolute h-10 w-10 -top-5 text-red-500 p-0.5`}/>) }
//                     {returnRequested.status && !returnRequested.rejected && (<MdDoneAll className={`bg-white absolute h-10 w-10 -top-5 text-green-500 p-1`}/>) }
//                     <h2 className={`text-center text-base font-sans font-semibold pb-2 ${returnRequested.rejected ? "text-red-500" : "text-green-500"}`}>Return Requested</h2>
//                     <p className='pt-2'><span className=' font-sans font-medium'>Requested on : </span><span className='font-poppins'>{date_time(returnRequested.date)}</span></p>
//                     <p className='pt-1.5'><span className=' font-sans font-medium'>Reason For Return : </span><span className='font-poppins'>{returnRequested.reason_for_return}</span></p>
//                     {returnRequested.rejected &&
//                         <div>
//                             <p className='pt-1.5'><span className=' font-sans font-medium'>Handled by : </span><span onClick={()=>navigate(`/admin/staff/${returnRequested.handled_by}`)} className='font-poppins hover:text-sky-500 cursor-pointer'>{returnRequested.handled_by}</span></p>
//                             <p className='pt-1.5'><span className=' font-sans font-medium'>Rejected : </span><span className='font-poppins'>True</span></p>
//                             <p className='pt-1.5'><span className=' font-sans font-medium'>Rejected on : </span><span className='font-poppins'>{date_time(returnRequested.rejected_date)}</span></p>
//                             <p className='pt-1.5'><span className=' font-sans font-medium'>Reason For Rejection : </span><span className='font-poppins'>{returnRequested.reason_for_rejection}</span></p>
//                         </div>
//                     }
//                 </div>

//                 {/* Returned */}
//                 <div className={`col-span-1 border-2 p-2 rounded-md -space-y-1 relative ${ returned.rejected ? 'border-red-500' : returned.status ? 'border-green-500' : ''}`}>
//                     {returned.rejected && (<RxCross2 className={`bg-white absolute h-10 w-10 -top-5 text-red-500 p-0.5`}/>) }
//                     {returned.status && (<MdDoneAll className={`bg-white absolute h-10 w-10 -top-5 text-green-500 p-1`}/>) }
//                     <h2 className={`text-center text-base font-sans font-semibold pb-2 ${returned.rejected ? "text-red-500" : "text-green-500"}`}>Returned</h2>
//                     <p className='pt-2'><span className=' font-sans font-medium'>Date : </span><span className='font-poppins'>{date_time(returned.date)}</span></p>
//                     {returned.rejected &&
//                     <div>
//                         <p className='pt-1.5'><span className=' font-sans font-medium'>Rejected : </span><span className='font-poppins'>True</span></p>
//                         <p className='pt-1.5'><span className=' font-sans font-medium'>Rejected by : </span><span className='font-poppins'>{returned.rejected_by}</span></p>
//                         {returned.rejected_by === 'staff' && <p className='pt-1.5'><span className=' font-sans font-medium'>Canceled Staff Id : </span><span onClick={()=>navigate(`/admin/staff/${returned.rejected_staff_id}`)} className='font-poppins hover:text-sky-500 cursor-pointer'>{returned.rejected_staff_id}</span></p>}
//                         <p className='pt-1.5'><span className=' font-sans font-medium'>Reason For Rejection : </span><span className='font-poppins'>{returned.reason_for_rejection}</span></p>
//                     </div>
//                     }
//                     {returned.status && 
//                         <p className='pt-1.5'><span className=' font-sans font-medium'>Picked up by : </span><span onClick={()=>navigate(`/admin/staff/${returned.pickeup_by}`)} className='font-poppins hover:text-sky-500 cursor-pointer'>{returned.pickeup_by}</span></p>
//                     }
//                 </div>
//                 {/* Refund */}
//                 <div className={`col-span-1 border-2 p-2 rounded-md -space-y-1 relative ${refund.status && 'border-green-500'}`}>
//                 {refund.status && (<MdDoneAll className={`bg-white absolute h-10 w-10 -top-5 text-green-500 p-1`}/>) }
//                 <h2 className='text-center text-base font-sans font-semibold pb-2 text-green-500'>Refund</h2>
//                 <p className='pt-2'><span className=' font-sans font-medium'>Refunded on : </span><span className='font-poppins'>{date_time(refund.date)}</span></p>
//                 <p className='pt-1.5'><span className=' font-sans font-medium'>Refund Amount : </span><span className='font-poppins'>{refund.refund_amount}</span></p>
//                 <p className='pt-1.5'><span className=' font-sans font-medium'>Refunded By : </span><span onClick={()=>navigate(`/admin/staff/${refund.refund_by}`)} className='font-poppins hover:text-sky-500 cursor-pointer'>{refund.refund_by}</span></p>
//             </div>
//                 {/* canceled */}
//                 <div className={`col-span-1 border-2 p-2 rounded-md -space-y-1 relative ${canceled.status && 'border-red-500'}`}>
//                     {canceled.status && (<MdDoneAll className='bg-white absolute h-10 w-10 -top-5 text-red-500 p-1'/>) }
