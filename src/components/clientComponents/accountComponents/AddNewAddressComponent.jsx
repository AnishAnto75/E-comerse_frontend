...
const AddNewAddressComponent = () => {
    ...
    const handleSubmit = async()=>{
        ...
        if (!name || !phone_number || !area || !city || !district || !state || !pincode ){ toast.warn("Fill all the required data"); return}
  ...
  return (
    ...
    { newAddress &&
        ...
        <div className="grid gap-5 p-2 font-medium grid-cols-10 text-lg">
            ...
            <div className="md:col-span-10 flex gap-5 mt-5">
                ...
                {addressLoading ?
                    <div className='w-full bg-gray-200 rounded-md'>
                        <LoadingComponent height={8} width={8}/>
                    </div>
                :
