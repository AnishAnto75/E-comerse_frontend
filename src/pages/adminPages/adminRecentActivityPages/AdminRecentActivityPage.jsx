            ...
            <div className="border flex flex-col mt-5 rounded-xl border-gray-100 p-5">
                ...
                <div className="mt-5 space-y-3 min-h-[calc(100vh-313px)] ">
                    ...
                    : activities?.map(activity => {
                        ...
                        return (
                            <div key={activity._id} className={` relative flex gap-5 items-center rounded-xl p-3 transition ${selectedActivity?._id == activity._id ? "bg-slate-100/80" : !activity.viewed ? "bg-sky-50/70" : "hover:bg-gray-50" }`} >
        ...
        {selectedActivity && (
            <div className='relative min-w-[26rem] max-w-[26rem] shrink-1 py-5 pr-5'>
                <div className='sticky top-5 h-[calc(100vh-40px)] rounded-xl shadow-lg border border-gray-100 overflow-y-auto p-3'>
                    <IoCloseSharp onClick={()=>setSelectedActivity(null)} className='absolute top-3 right-3 text-4xl cursor-pointer z-10 rounded-full hover:bg-red-50 text-red-500 p-1' />
