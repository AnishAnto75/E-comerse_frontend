...
const AdminAddNewBrandPage = () => {
    ...
    const handleSubmit = async(e)=>{
        ...
        try {
            setLoading(true) 
            console.log(data)
            const res = await axios.post(`${import.meta.env.VITE_BACKEND_URL}admin/brand/create-brand` , {data})
        ...
        <div className="p-6 place-items-center w-full ">
            ...
            <div className="bg-gray-50 rounded-xl container max-w-screen-xl shadow-lg p-4 px-4 md:p-8 my-3 gap-4 gap-y-2 text-base">
                <div className="text-md text-gray-700 ">
                    ...
                    <div className="mb-2">
                        <label htmlFor="brand">Brand Description<span className="text-red-500 pl-0.5">*</span></label>
                        <textarea type="text" name="Brand_description" id="Brand_description" autoComplete="off" required value={Brand_description} onChange={(e)=>setBrandDescription(e.target.value)} ref={input2Ref} className="border border-gray-300 text-sm p-1.5 w-full rounded-md resize-none h-28" />
                    </div>
