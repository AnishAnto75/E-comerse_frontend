...
//   return (
//     <Card shadow={false} className="w-full p-2">
//         <CardHeader floated={false} shadow={false} className="rounded-none pb-4 pr-5">
...
//                                         <div className="font-normal opacity-70">{product_barcode}</div>
//                                     </div>
//                                 </div>
//                             </td>
//                             <td className={classes}>
